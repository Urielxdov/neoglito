      ...
      <div className='flex flex-col gap-6 p-5 sm:p-7'>
        <div className='overflow-hidden rounded-lg border border-[#e0e6ef] dark:border-[#253044]'>
          ...
          {repositories.map((repository, index) => (
            <div
              key={repository.id}
              className={`grid grid-cols-[minmax(0,1fr)_120px] items-center gap-3 px-4 py-[11px] ${
                index === 0
                  ? ''
        ...
        <div className='flex flex-col gap-2.5'>
          <div className='flex flex-col gap-0.5'>
            <span className='text-[15px] font-semibold text-[#16202e] dark:text-[#e8edf6]'>
              Archivos de despliegue
            </span>
            <span className='text-[12.5px] text-[#8c98ac] dark:text-[#7a8699]'>
              Uno por repositorio. Escribe la ruta y, si aplica, sus variables
              de entorno.
            </span>
          </div>
                ...
                >
                  ...
                  >
                    ...
                    <svg
                      ...
                      strokeLinecap='round'
                      strokeLinejoin='round'
                      className={`shrink-0 text-[#8c98ac] transition-transform dark:text-[#7a8699] ${
                        open ? 'rotate-90' : ''
                      }`}
                    >
                      <path d='m9 6 6 6-6 6' />
                    ...
                    <div className='flex flex-col gap-4 border-t border-[#e6eaf0] bg-[#f8fafc] px-4 py-4 pl-[58px] dark:border-[#253044] dark:bg-[#0c121d]'>
                      <div className='flex flex-col gap-1.5'>
                        ...
                        <input
                          value={path}
                          onChange={event =>
                            onPathChange(key, event.target.value)
                          }
